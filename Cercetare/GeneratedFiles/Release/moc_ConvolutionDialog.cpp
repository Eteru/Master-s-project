...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ConvolutionDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ConvolutionDialog_t qt_meta_stringdata_ConvolutionDialog = {
    {
QT_MOC_LITERAL(0, 0, 17), // "ConvolutionDialog"
QT_MOC_LITERAL(1, 18, 17), // "KernelSizeChanged"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 21) // "OnSubmitButtonClicked"

    },
    "ConvolutionDialog\0KernelSizeChanged\0"
    "\0OnSubmitButtonClicked"
};
...
void ConvolutionDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->KernelSizeChanged(); break;
...
const QMetaObject ConvolutionDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ConvolutionDialog.data,
      qt_meta_data_ConvolutionDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ConvolutionDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ConvolutionDialog.stringdata0))
